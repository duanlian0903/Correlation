...
def get_tcp_confidence_interval(tcp, n, alpha):
    if whether_within_probability_range(tcp) & whether_within_probability_range(alpha):
        z_score = aocaddpvass.get_normal_distribution_z_score(alpha/2)
        se = (tcp*(1-tcp)/n) ** 0.5
...
def get_added_value(contingency_table_dict):
    try:
        return contingency_table_dict['n11'] / (contingency_table_dict['n11'] + contingency_table_dict['n10']) - (
                contingency_table_dict['n11'] + contingency_table_dict['n01']) / (
                       contingency_table_dict['n11'] + contingency_table_dict['n10'] + contingency_table_dict[
                   'n01'] + contingency_table_dict['n00'])
    except:
        return 0
...
def get_relative_risk(contingency_table_dict):
    try:
        return (contingency_table_dict['n11'] * (contingency_table_dict['n01'] + contingency_table_dict['n00'])) / (
                contingency_table_dict['n01'] * (contingency_table_dict['n11'] + contingency_table_dict['n10']))
    except:
        return 1
...
def get_relative_risk_confidence_interval(contingency_table_dict, alpha):
    z_score = aocaddpvass.get_normal_distribution_z_score(alpha/2)
    try:
        se = (contingency_table_dict['n10'] / ((contingency_table_dict['n11'] + contingency_table_dict['n10']) * contingency_table_dict['n11'])
              + contingency_table_dict['n00'] / ((contingency_table_dict['n01'] + contingency_table_dict['n00']) * contingency_table_dict['n01'])) ** 0.5
...
def get_odds_ratio(contingency_table_dict):
    try:
        return (contingency_table_dict['n11'] * contingency_table_dict['n00']) / (
                contingency_table_dict['n10'] * contingency_table_dict['n01'])
    except:
        return 1
...
def get_correlation_degree_confidence_interval_point_estimation(correlation_degree_confidence_interval, independent_value):
    ...
    if point_estimation != independent_value:
        check = 1
...
def get_phi_coefficient(contingency_table_dict):
    try:
        return (contingency_table_dict['n11'] * contingency_table_dict['n00'] - contingency_table_dict['n10'] *
                contingency_table_dict['n01']) / math.sqrt(
            (contingency_table_dict['n11'] + contingency_table_dict['n10']) * (
                    contingency_table_dict['n01'] + contingency_table_dict['n00']) * (
                    contingency_table_dict['n10'] + contingency_table_dict['n00']) * (
                    contingency_table_dict['n11'] + contingency_table_dict['n01']))
    except:
        return 0
...
def get_conviction(contingency_table_dict):
    try:
        return ((contingency_table_dict['n11'] + contingency_table_dict['n10']) * (
                contingency_table_dict['n10'] + contingency_table_dict['n00'])) / ((contingency_table_dict['n11'] +
                                                                                    contingency_table_dict['n10'] +
                                                                                    contingency_table_dict['n01'] +
                                                                                    contingency_table_dict['n00']) *
                                                                                   contingency_table_dict['n10'])
    except:
        return 1
...
def get_pair_correlation(contingency_table_dict, correlation_type, cc=0.5):
    n = contingency_table_dict['n11'] + contingency_table_dict['n10'] + contingency_table_dict['n01'] + \
        contingency_table_dict['n00']
    tcp = contingency_table_dict['n11'] / n
    ecp = (contingency_table_dict['n11'] + contingency_table_dict['n10']) / n * (
            contingency_table_dict['n11'] + contingency_table_dict['n01']) / n
    itemset_size = 2
